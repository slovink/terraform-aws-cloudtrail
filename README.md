...
<a href="https://github.com/slovink/slovink-terraform-aws-cloudtrail/blob/dev/LICENSE">
...
<a href='https://www.facebook.com/Slovink.in=https://github.com/slovink/slovink-terraform-aws-cloudtrail'>
  <img title="Share on Facebook" src="https://user-images.githubusercontent.com/50652676/62817743-4f64cb80-bb59-11e9-90c7-b057252ded50.png" />
</a>
<a href='https://www.linkedin.com/company/101534993/admin/feed/posts/=https://github.com/slovink-terraform-aws-cloudtrail'>
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/slovink/slovink-terraform-aws-cloudtrail/tree/dev/_example) directory within this repository.

## License
This Terraform module is provided under the '[License Name]' License. Please see the [LICENSE](https://github.com/slovink/slovink-terraform-aws-cloudtrail/blob/dev/LICENSE) file for more details.
...
**IMPORTANT:** Since the `master` branch used in `source` varies based on new modifications, we suggest that you use the release versions [here](https://github.com/slovink/slovink-terraform-aws-cloudtrail.git).
...
## Feedback
If you come accross a bug or have any feedback, please log it in our [issue tracker](https://github.com/slovink/slovink-terraform-aws-cloudtrail/issues), or feel free to drop us an email at [devops@slovink.com](mailto:devops@slovink.com).

If you have found it worth your time, go ahead and give us a ★ on [our GitHub](https://github.com/slovink/slovink-terraform-aws-cloudtrail.git)!
